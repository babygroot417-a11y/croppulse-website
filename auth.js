...
if(!valid){show('Firebase is not configured.');}
 ...
 document.getElementById('sendOtp').addEventListener('click',async()=>{
   ...
   try{show('Sending verification code…',false); const btn=document.getElementById('sendOtp');btn.disabled=true; confirmationResult=await signInWithPhoneNumber(auth,phone,verifier); phoneBox.hidden=true;otpBox.hidden=false;show('OTP sent. Check your phone.',false);}
